...
function ResearchPublications() {
  ...
  // stable reference to publications
  const publications = useMemo(() => PUBLICATIONS, []);

  // Build “recent 5” for the carousel (year ↓, then parsed DD-MM-YYYY ↓, then insertion order)
