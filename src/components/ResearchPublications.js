...
function ResearchPublications() {
  ...
  // ------------------------------
  // Your master publications object
  // ------------------------------
  const publications = {
    'Journal Articles': [
      ...
      { authors: 'Tipu, Rupesh Kumar; Batra, Vandna; Suman.',
        ...
        doi: '10.1007/s42107-024-00838-4' },
      { authors: 'Tipu, Rupesh Kumar; Suman; Batra, Vandna; Panchal, VR; Pandya, KS; Patel, Gaurang A.',
        year: 2024,
    ...
    'Conference Proceedings': [
      { authors: 'Tipu, Rupesh Kumar; Panchal, VR; Pandya, KS; Tipu, R.K.',
        ...
        volume: 2273, number: 1, article: '012016',
      ...
      { authors: 'R. K. Tipu, O. A. Shah, S. Vats and S. Purohit.',
        ...
        conference: '2024 4th International Conference on Innovative Practices in Technology and Management (ICIPTM)', doi: '' },
    ...
    Patents: [
      { authors: 'Rupesh Kumar Tipu',
        ...
        country: 'India', patentNumber: '202411014830',
        date: '08-03-2024', status: 'Published', doi: '' },
      { authors: 'Rupesh Kumar Tipu',
        year: 2024,
        title: 'MACHINE LEARNING-BASED GUI FOR ESTIMATING THE STRENGTH OF RECYCLED AGGREGATE CONCRETE',
        country: 'India', patentNumber: '202411011153',
        date: '23-02-2024', status: 'Published', doi: '' },
      { authors: 'Rupesh Kumar Tipu',
        year: 2024,
        title: 'INNOVATIVE GUI-BASED APPROACH FOR PREDICTING FLOW AND COMPRESSIVE STRENGTH IN HIGH-PERFORMANCE CONCRETE',
        country: 'India', patentNumber: '202411007500',
        date: '16-02-2024', status: 'Published', doi: '' },
      { authors: 'Rupesh Kumar Tipu',
        year: 2024,
        title: 'INTELLIGENT PREDICTIVE SYSTEM AND USER INTERFACE FOR HIGH-PERFORMANCE CONCRETE COMPRESSIVE STRENGTH ASSESSMENT',
        country: 'India', patentNumber: '202411007359',
        date: '02-02-2024', status: 'Published', doi: '' },
      { authors: 'Rupesh Kumar Tipu',
        year: 2024,
        title: 'Machine Learning Enhanced Graphical Interface for Optimized Concrete Mix Design',
        country: 'India', patentNumber: '202411019684',
        date: '16-03-2024', status: 'Published', doi: '' },
      { authors: 'Rupesh Kumar Tipu',
        year: 2024,
        title: 'Real-Time Interactive Water Quality Prediction System Utilizing Ensemble Machine Learning and GUI Visualization',
        country: 'India', patentNumber: '202411057196',
        date: '28-07-2024', status: 'Published', doi: '' },
    ],
  };

  // ------------------------------
  // Build "recent 5" for the carousel
  // ------------------------------
  const recentFiveForCarousel = useMemo(() => {
    // helper: parse DD-MM-YYYY (patents) or ignore if not in that format
    const parseDMY = (s) => {
      if (!s) return 0;
    ...
    let seq = 0; // preserves insertion order as a last tiebreaker
    const flatten = [];
    ...
    publications['Journal Articles'].forEach((p) => {
      flatten.push({
        ...
        sortDate: parseDMY(String(p.date || '')) || 0,
        seq: ++seq,
      });
    });
    ...
    // Sort: by year ↓, then parsed date ↓, then insertion order ↓
  ...
  return (
    <section id="publications" className="research-publications" data-aos="fade-up">
      <div className="container">
        ...
        {/* NEW: show latest 5 items as a carousel right here */}
        <div style={{ margin: '12px 0 24px' }}>
          <PublicationsCarousel publications={recentFiveForCarousel} />
        </div>
